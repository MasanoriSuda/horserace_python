...
from core.scrape_horserace_util import getRaceResultLocal,getRaceResultJRA, getHorseInfo, getDateForDataAnalysis
from core.scrape_jockeytable import jockey_mappings
from config.JBC2023.scrape_config_train_test_objectrace import horse_race_lists
    ...
    for horse_id in horse_id_list:
        ...
        for num in range(len(date)):
            ...
            if tmp_racetrack > 10 and tmp_racetrack <= 100   :
                ...
                tmp_race      = str(int(race_num[num])) if  int(race_num[num]) >= 10 else "0" +  str(int(race_num[num]))
