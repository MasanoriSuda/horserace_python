...
model.add(Dense(1250, activation='relu', input_shape=(19,)))
...
#ニューラルネットワークの学習
history = model.fit(x_train, y_train,batch_size=1225*20,epochs=1000,verbose=1,validation_data=(x_test, y_test))
